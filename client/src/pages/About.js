            ...
            <div className="col-12 col-lg-6 col-xl-7">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-4 text-secondary mb-3"><b>FOARAN IMPEX</b>  where culinary excellence meets innovation. As a leading company, we are committed to transforming kitchens with our premium stainless steel products. Our focus on quality and design ensures that every experience with us reflects our dedication to creating a seamless blend of tradition and cutting-edge technology. Explore a new era of cooking and discover the difference with us.</p>
